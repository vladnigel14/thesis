...
<<<<<<< HEAD
$query=mysqli_query($db_connection,"SELECT db_clients.clientID,db_clients.fullname,db_clients.contact,db_clients.address,db_clients.SRent,db_clients.ERent,db_deadreg.deceasedID,db_deadreg.Firstname,db_deadreg.Lastname FROM db_clients LEFT OUTER JOIN db_deadreg ON db_clients.clientID=db_deadreg.clientID where db_clients.fullname like '%$searchq%' OR db_clients.clientID like '%$searchq%'");
=======
...
>>>>>>> 59149a8c1993fa73019c59730f18f9b692d0168a
